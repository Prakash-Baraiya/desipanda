...
def start(update: Update, context: CallbackContext) -> None:
    update.message.reply_text('Hi! Send me a text or .txt file and I will use two backspace characters before replacing "https" with ":https".')
...
def handle_document(update: Update, context: CallbackContext) -> None:
    ...
    with open('temp.txt', 'r') as f:
        text = f.read()
    text = re.sub(r'https', r'\b\b:https', text)
